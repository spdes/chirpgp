"""
Compute the EKF error of the model.
"""
import argparse
import math
import jax
...
from chirpgp.filters_smoothers import ekf
...
def filtering(measurements):
    mfs, _, _ = ekf(m_and_cov, H, Xi, m0, P0, dt, measurements)
    return mfs[:, 1], mfs[:, 2]
...
file_name = f'./results/crlb_ekf_lam_{lam}_b_{b}_Xi_{Xi}.npz'
